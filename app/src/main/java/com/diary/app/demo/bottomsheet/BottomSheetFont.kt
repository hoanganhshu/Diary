...
import com.diary.app.demo.adapter.FontAdapter
...
class BottomSheetFont(
    ...
    override fun onCreateView(
        ...
        val fontItems = listOf(
            "Nunito" to R.font.nunitovariablefont_wght,
            "Amiri" to R.font.amiriregular,
            "Merriweather" to R.font.merriweatherregular,
            "Bad Script" to R.font.badscriptregular,
            "Cardo" to R.font.cardoregular,
            "League Gothic" to R.font.leaguegothicregularvariablefont_wdth,
            "Great Vibes" to R.font.greatvibesregular,
            "Pacifico" to R.font.pacificoregular,
            "Coming Soon" to R.font.comingsoonregular,
            "Amatic Bold" to R.font.amaticscbold,
            "Lobster" to R.font.lobsterregular,
            "Reem Kufi" to R.font.reemkufivariablefont_wght,
            "Dancing Script" to R.font.dancingscriptvariablefont_wght,
            "Cutive Mono" to R.font.cutivemonoregular
        )

        binding.fontstyle.layoutManager =
            GridLayoutManager(requireContext(), 2)
        binding.fontstyle.adapter = FontAdapter(fontItems) { index ->
