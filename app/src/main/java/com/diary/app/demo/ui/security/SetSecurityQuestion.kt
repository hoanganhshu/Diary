package com.diary.app.demo.ui.security
...
class SecurityQuestionActivity : BaseActivity<ActivitySetSecurityQuestionBinding>() {
    ...
    @Inject lateinit var securityModel: SecurityRepository

    override fun getLayoutActivity(): Int = R.layout.activity_set_security_question
