package com.diary.app.demo.ui.unlock
...
import com.diary.app.demo.ui.passcode.PassCodeActivity
...
class UnlockPattern : BaseActivity<ActivityUnlockPatternBinding>() {
    ...
    override fun getLayoutActivity(): Int = R.layout.activity_unlock_pattern
    ...
    override fun initViews() {
        ...
        isSetupPin = intent.getBooleanExtra(PassCodeActivity.Companion.EXTRA_IS_SETUP_PIN, false)
        isChangePin = intent.getBooleanExtra(PassCodeActivity.Companion.CHANGE_PIN_REQUEST, false)
        when {
            isSetupPin -> {
        ...
        mBinding.tvForgot.setOnClickListener {
            ...
            intent.putExtra(SecurityQuestionActivity.Companion.EXTRA_MODE, SecurityQuestionActivity.Companion.MODE_RECOVER)
